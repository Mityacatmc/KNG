 ...
 */
export declare const File: ({ children, align, size, mode, stretched, before, after, loading, className, style, getRef, getRootRef, appearance, ...restProps }: FileProps) => React.JSX.Element;

 ...
 */
export declare const DEFAULT_ARROW_WIDTH = 20;
export declare const DEFAULT_ARROW_HEIGHT = 8;
export declare const DEFAULT_ARROW_PADDING = 10;
export declare const DefaultIcon: (props: React.SVGAttributes<SVGSVGElement>) => React.JSX.Element;

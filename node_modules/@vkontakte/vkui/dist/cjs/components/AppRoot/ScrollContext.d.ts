...
export declare const GlobalScrollController: ({ children }: ScrollControllerProps) => React.JSX.Element;
export declare const ElementScrollController: ({ elRef, children }: ScrollControllerProps) => React.JSX.Element;
/**

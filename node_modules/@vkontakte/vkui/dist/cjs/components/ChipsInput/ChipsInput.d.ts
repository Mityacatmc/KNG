 ...
 */
export declare const ChipsInput: <Option extends ChipOption>({ style, className, getRootRef, before, after, status, mode, ...restProps }: ChipsInputProps<Option>) => React.JSX.Element;

 ...
 */ function chunkArray(array, size) {
    ...
    return [
        head
    ].concat(_to_consumable_array._(chunkArray(tail, size)));
}
/**
 ...
 */ function omitFromArray() {
    ...
    if (index < 0) {
        ...
        return _to_consumable_array._(array.slice(0, index)).concat(_to_consumable_array._(array.slice(index + 1)));
    }
}
/**
